...
"ch1": {
  ...
  "tsn2": {
    ...
    type: "mpd",
    keys: [{ k1: "daa8ea92553fd16cd6bfae2b8c582715", k2: "4042e041b5639b79b69ae07a872eef9b" }]
  },
  "tsn3": {
    ...
    type: "mpd",
    keys: [{ k1: "f5c2b30eac11be1e8cdfc9585f5fe6af", k2: "a8198d17bf9b0da77450fbb919a38b2d" }]
  },
  "tsn4": {
    ...
    type: "mpd",
    keys: [{ k1: "c4088f5f265f9de50cffd80bf89308b7", k2: "2c4d2239d96d532b4ec2050653611003" }]
  },
  "tsn5": {
    url: "https://otte.cache.aiv-cdn.net/bom-nitro/clients/dash/enc/jkcljgqbx8/out/v1/63bfa701559340f3a2a2cb1fccd24807/cenc.mpd",
    type: "mpd",
    keys: [{ k1: "e853333da2c9196ea11374634231bc45", k2: "de2e2dbe818d78dfad07d6cd9a4c63d4" }]
  },
  "spotv": {
    url: "https://qp-pldt-live-bpk-01-prod.akamaized.net/bpk-tv/cg_spotvhd/default/index.mpd",
    type: "mpd",
    keys: [{ k1: "ec7ee27d83764e4b845c48cca31c8eef", k2: "9c0e4191203fccb0fde34ee29999129e" }]
  },
  "spotv2": {
    url: "https://qp-pldt-live-bpk-01-prod.akamaized.net/bpk-tv/dr_spotv2hd/default/index.mpd",
    type: "mpd",
    keys: [{ k1: "7eea72d6075245a99ee3255603d58853", k2: "6848ef60575579bf4d415db1032153ed" }]
  },
  "tudnusa": {
    url: "https://aka-live1-ott.izzigo.tv/1/out/u/dash/TUDN-HD/default.mpd",
    type: "mpd",
    keys: [{ k1: "2722647f77b44824c432a3c4555830a2", k2: "1734befb82f4b438bd84195f6c212e7b" }]
  },
  "nova1": {
  ...
  "usanetwork": {
    ...
    type: "mpd",
    keys: [{ k1: "043ba1b4a2823fc4a6033178f3560431", k2: "684358d80874b55f9335c73126e4d44e" }]
  },
  "telemundo": {
    url: "https://live-oneapp-prd-news.akamaized.net/Content/CMAF_OL2-CTR-4s/Live/channel(WNJU)/master.mpd",
    type: "mpd",
    keys: [{ k1: "c71fe7bc82f037c6af21fd299d6341b0", k2: "13223c98886ff43d3c5f271eeb457cc6" }]
  },
  "tudnmx": {
  ...
  "nbc": {
    ...
    type: "mpd",
    keys: [{ k1: "0045a118e231f1326bcdb45350b1ceaa", k2: "8c13afbfa54ea37a368b8b859021f6e3" }]
  },
  "universo": {
    url: "https://live-oneapp-prd-news.akamaized.net/Content/CMAF_OL2-CTR-4s/Live/channel(universo-east)/master.mpd",
    type: "mpd",
    keys: [{ k1: "96b67fa09140329a89b7a1ead134eda3", k2: "c618d32c56cdc6cad8330eb98507ca3f" }]
  },
  "ziggosp": {
    ...
    type: "mpd",
    keys: [{ k1: "ef34ae91b4f2415e8439b2ad105e7488", k2: "243248d8de1ff8c7c587ee2057317523" }]
  },
  "ziggo2": {
    ...
    type: "mpd",
    keys: [{ k1: "3cfa8625f650406ebf6a4d1ea737f572", k2: "0534e747c70b364aa7210e1bf3191df0" }]
  },
  "ziggo3": {
    ...
    type: "mpd",
    keys: [{ k1: "4dbea4b5713a4aa1ae3a2544cd522fc7", k2: "a8323ea99b2d6200a48e1bc27322d548" }]
  },
  "ziggo4": {
    ...
    type: "mpd",
    keys: [{ k1: "16bf72dc22743d929c4318e193408373", k2: "eae51a1e3904124963074cbf432c7c8e" }]
  },
  "ziggo5": {
    ...
    type: "mpd",
    keys: [{ k1: "3fb40d85724942f994d86943f48021db", k2: "a6da8742502c8a2153067f5f2a70fb02" }]
  },
  "ZIGGO6": {
    ...
    type: "mpd",
    keys: [{ k1: "1a0ffa532aa2498490826e2f6a37f7c9", k2: "a8cec27bc7d47909c5b0d8f473b43e8d" }]
  },
  "daznlaliga": {
    ...
    type: "mpd",
    keys: [{ k1: "43d1c3b25207ff38b22ccfe17d302367", k2: "7b1f85f6e81059473b114c16a25c829a" }]
  },
  "laligatv": {
    ...
    type: "mpd",
    keys: [{ k1: "6d08b265a6639e32da7c880d5491e3d2", k2: "0c92556ca14b95f367993710e7cfbc94" }]
  },
  "espn2nl": {
  ...
  "espn3nl": {
    ...
    type: "mpd",
    keys: [{ k1: "0355f64277082b903022985035c498ca", k2: "7a8ed20a4958398677e2c9ccd5a53a00" }]
  },
  "espn1mx": {
    url: "https://bks400-tol-110.quieroxview.com.mx/bpk-tv/espn_hd/default/index.mpd",
    type: "mpd",
    keys: [{ k1: "52358519f886446d82834a803b36f796", k2: "58b6ac8e07d354b178255e03b9d0f819" }]
  },
  "espn2mx": {
  ...
  "bein2aus": {
    ...
    type: "mpd",
    keys: [{ k1: "0b42be2664d7e811d04f3e504e0924c5", k2: "ae24090123b8c72ac5404dc152847cb8" }]
  },
  "bein3aus": {
    ...
    type: "mpd",
    keys: [{ k1: "7995c724a13748ed970840a8ab5bb9b3", k2: "67bdaf1e2175b9ff682fcdf0e2354b1e" }]
  },
  "premier1": {
    ...
    type: "mpd",
    keys: [{ k1: "1444f4235529f183f0a5a486befe9cdb", k2: "e5e3fec67a1bb3472a2089c8a0a2557f" }]
  },
  "premier2": {
    ...
    type: "mpd",
    keys: [{ k1: "1a5df53609ebc9857898c490f4724918", k2: "77f62980d582ec541280796acf8b2d19" }]
  },
  "go3s1": {
    url: "https://v4-pan-n79-cdn-01.live.cdn.cgates.lt/live/dash/560502/index.mpd",
    type: "mpd",
    keys: [{ k1: "f48a8131e05f4d6e84de19f086c781a6", k2: "fd28f2f966a906f4d4dcfd72ae90094e" }]
  },
  "go3s2": {
    url: "https://v4-pan-n79-cdn-01.live.cdn.cgates.lt/live/dash/560502/index.mpd",
    type: "mpd",
  ...
  "italia1": {
    ...
    type: "mpd",
    keys: [{ k1: "00f9f3c0783536b8ee91704e23b78016", k2: "bfd04d6f544c9cc4d35cb13ab6778587" }]
  },
  "skytede": {
    ...
    type: "mpd",
    keys: [{ k1: "04e1aff27c2a13ad9aa9556501684743", k2: "2097e55038d3cee7d69e88f4069840d1" }]
  },
  "skymixde": {
